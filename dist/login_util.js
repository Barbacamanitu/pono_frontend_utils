...
export class LoginUtil {
    static saveCredsToLocalStorage(creds) {
    ...
    static validateCredentialsExpiration(creds) {
    ...
    static getCredsFromLocalStorage() {
        ...
        const logged_in_at_num = +logged_in_at;
    ...
    static loginResponseToCredentials(cred_res) {
        let creds = { logged_in: false, username: "", access_token: "", refresh_token: "", logged_in_at: 0 };
        if (!cred_res) {
            return creds;
        }
